...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    @Query("SELECT new com.backend.event_service.dto.user.UserGuestDTO(u.id, u.firstName, u.lastName, u.login) FROM User u JOIN Booking b ON u.login = b.userLogin WHERE b.eventId = :eventId")
